...
<h4 class="country-text">India</h4>
                  ...
                  <h5 class="current-date-text regular-text">  Mon, 12 Jun</h5>
            </div> 

            <div class="weather-summary-container">
                  <img src="assets-1/assets/weather/clouds.svg" class="weather-summary-img">
...
air
          ...
          <div class="forecast-items-container">
            <div class="forecast-item">
                  ...
                  <img src="assets-1/assets/weather/thunderstorm.svg" class="forecast-item-img">
       ...
       <section class="search-city section-message">
            <img src="assets-1/assets/message/search-city.png">
             <div>
                  <h1>Search City</h1>
        ...
        <section class="not-found section-message" style="display: none;">
            <img src="assets-1/assets/message/not-found.png">
             <div>
                  <h1>Search City</h1>
                  <h4 class="regular-txt">
                        Find out the weather conditions of the city
